...
export const YEARS = [
  {
    year: 2021,
    key: 'Beginning',
    lines: ['Started B.Tech CSE (AIML)', 'Brainware University', 'New chapter began'],
  },
  {
    year: 2022,
    key: 'Exploration',
    lines: ['Learned Python', 'Explored AI/ML fundamentals', 'Found direction'],
  },
  {
    year: 2023,
    key: 'Building',
    lines: ['First ML projects', 'Learned web development', 'Kept going'],
  },
  {
    year: 2024,
    key: 'Engineering',
    lines: ['Built AI bug detection', 'Network security ML', 'Real systems'],
  },
  {
    year: 2025,
    key: 'Scaling',
    lines: ['InboxOS email automation', 'Full-stack AI apps', 'Stepped up'],
  },
  {
    year: 2026,
    key: 'Next chapter',
    lines: ['Graduating B.Tech', 'Seeking opportunities', 'Still building'],
  },
];
